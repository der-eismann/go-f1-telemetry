...
var TrackName = map[int8][2]string{
	...
	27: {"Imola, Italy", "it"},
	28: {"Portimão, Portugal", "pt"},
	29: {"Jeddah, Saudi Arabia", "sa"},
}
...
var Teams = map[uint8][2]string{
	...
	3:   {"Williams Racing", "005aff"},
	4:   {"Aston Martin F1 Team", "006f62"},
	5:   {"Alpine F1 Team", "0090ff"},
	6:   {"Scuderia AlphaTauri", "2b4562"},
	7:   {"Haas F1 Team", "ffffff"},
	8:   {"McLaren F1 Team", "FF9800"},
	...
	85:  {"Mercedes-AMG F1 Team", "00d2be"},
	86:  {"Scuderia Ferrari", "dc0000"},
	87:  {"Red Bull Racing", "0600ef"},
	88:  {"Williams Racing", "0082fa"},
	89:  {"Racing Point F1 Team", "F596C8"},
	90:  {"Renault F1 Team", "FFF500"},
	91:  {"Scuderia AlphaTauri Honda", "ffffff"},
	92:  {"Haas F1 Team", "787878"},
	93:  {"McLaren F1 Team", "FF8700"},
	94:  {"Alfa Romeo Racing", "960000"},
